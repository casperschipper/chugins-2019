...
CHUGINS=ABSaturator AmbPan Bitcrusher Buffer Clip DelayC KasFilter MagicSine FIR FoldbackSaturator \
	...
	Binaural ExpEnv Perlin Random Wavetable Linseg \
	Dust Mtof Scaler Tanh
